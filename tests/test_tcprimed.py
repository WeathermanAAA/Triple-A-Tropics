...
class TestChannelMap(unittest.TestCase):
    ...
    def test_source_credit(self):
        # The data is credited ONLY as NOAA/CIRA TC-PRIMED.
        self.assertEqual(tcprimed.SOURCE, "NOAA/CIRA TC-PRIMED")
        self.assertNotIn("the-reference-archive", tcprimed.SOURCE)
        self.assertNotIn("the-reference-archive", tcprimed.DISCLOSURE)
