...
| 23:09 | First tier releases | steal 74.2 %, idle 22.1 %, load 2.4: the limiter stepping back up, ~1 h 45 min after conus-fast2 was paused and ~3 h 45 min after Step 1; deploy trigger is two consecutive ticks under 50 % (script staged as /root/tat-step3-deploy.sh) |
